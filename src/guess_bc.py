...
bc_bp = Blueprint('bc', __name__, url_prefix='/bc')
...
<body>
    ...
    <br>
    <a href="{{ url_for('bc.reset') }}">重新開始</a>
    <hr>
    <a href="/">回首頁 (選遊戲)</a>
    <hr>
